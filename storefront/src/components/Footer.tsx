...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-bg-subtle border-t border-border-base w-full mt-16"
      data-testid="footer"
    >
      <div className="content-container flex flex-col w-full">
        <div className="flex flex-col gap-y-12 lg:flex-row items-start justify-between py-16">
          <div className="lg:w-1/3">
            ...
            <p className="mt-4 text-fg-subtle max-w-md">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            <div className="flex flex-col gap-y-4">
              ...
              <ul className="space-y-3" data-testid="footer-collections">
                <li>
                  <Link
                    className="text-fg-subtle hover:text-fg-subtle transition-colors"
        ...
        <div className="border-t border-border-base pt-8 pb-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <span className="txt-small text-fg-subtle">
              © {new Date().getFullYear()} Medusa Store. All rights reserved.
            </span>
            <div className="flex gap-6">
              <Link
                className="txt-small text-fg-subtle hover:text-fg-subtle transition-colors"
                to="/privacy-policy"
              >
                Privacy Policy
              </Link>
