          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <PopoverPanel className="flex flex-col absolute w-full pr-4 small:pr-0 small:w-1/3 2xl:w-1/4 small:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 txt-small text-white m-2 backdrop-blur-2xl">
                  <div
