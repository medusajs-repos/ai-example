  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium-plus text-primary-text">Order ID:</span>
        <span className="text-sm text-secondary-text">
          {formatOrderId(`${order.display_id || order.id}`)}
        </span>
      </div>
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium-plus text-primary-text">Order Date:</span>
        <span className="text-sm text-secondary-text">
      ...
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium-plus text-primary-text">Order Status:</span>
        <span className="text-sm text-secondary-text">{order.status}</span>
      </div>
      <div className="flex gap-2 items-center">
        <span className="text-base font-medium-plus text-primary-text">Order Email:</span>
        <span className="text-sm text-secondary-text">
  ...
  return (
    <div className="flex items-center gap-4 py-3 border-b border-primary-border last:border-b-0">
      ...
      <div className="flex-1 flex flex-col gap-y-1">
        <span className="text-base font-medium-plus text-primary-text">{item.product_title}</span>
        {item.variant_title && item.variant_title !== "Default Variant" && (
          <span className="text-sm text-secondary-text">{item.variant_title}</span>
        )}
        <span className="text-sm text-secondary-text">Quantity: {item.quantity}</span>
      </div>
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <span className="text-base font-medium-plus text-primary-text mb-2">Payment Method</span>
          <div className="text-sm text-secondary-text">
